...
router.post('/propiedades/crear',
   ...
   guardar
) // Le pasamos los errores de los campos para que no se valla vacio 
...
// Cambiamos el estado de la propiedda
...
// "dev" este ejecuta dos scripts de manera simultanea
// "db:importar", "db:eliminar"  el db importar inserta informacion en la base de datos, y el db elimnar trunca la base de datos y genera la base de nuevo desde cero 